...
- [ ] **W5 — 711 notes (62%) have no tags.** Original notes lost `child_vocab`, `phase::*`, and `domain::*` tags. Backfill from the populated Phase and Domains fields. (R5)
...
- [ ] **W10 — Phase badge not displayed on cards.** The Phase field is populated but no template renders it. Add `phase-{{Phase}}` badge to card headers. (R7)
